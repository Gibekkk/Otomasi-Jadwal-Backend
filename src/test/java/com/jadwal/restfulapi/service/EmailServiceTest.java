...
import com.jadwal.restfulapi.dto.EmailDetails;
...
class EmailServiceTest {
    ...
    private final String SENDER_EMAIL = "noreply@jadwal.com";
    ...
    class SendOTPRegisToLogin {
        ...
        void whenUserAndOtpProvided_thenHtmlIsBuiltAndSent() throws Exception {
            ...
            assertThat(capturedMessage.getAllRecipients()[0].toString()).isEqualTo("gibekkk@jadwal.com");
